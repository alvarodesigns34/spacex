...
export const VEHICLES = [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Trunk', value: 'solar array on one half, radiator on the other; jettisoned before re-entry', source: 'nasa', ref: 'nasa_ccp_presskit' },
      { label: 'Draco placement', value: 'near the base of the capsule, and more under the nose cone', source: 'nasa', ref: 'nasa_ccp_presskit' },
      ...
      { label: 'Windows', value: 'three (NASA press kit); two of them on the outer shell, one each side of the side hatch, as every photograph shows, and none in the side hatch', source: 'nasa', ref: 'nasa_ccp_presskit' },
      { label: 'Third window', value: 'not on the shell that shows with the nose cone closed: most likely the forward hatch window under the cone (inferred, not photographed here); not modelled', source: 'derived', approx: true },
    ],
    approximations: [
    ...
    sources: ['spacex_dragon', 'wiki_dragon2', 'wiki_dragon_crew', 'nasa_ccp_presskit', 'nasa_crew1_recovery', 'nasa_crew4_recovery', 'nasa_ax3_approach', 'nasa_endeavour_docked', 'nasa_crew10_hangar'],
    presets: [
