...
Ahora:
- el campo de losetas baja hasta 0,1 m del borde, y son 13 361 losetas en lugar de 13 132;
- el faldón es del mismo acero que los tanques, con larguerillos cada ≈0,45 m en la cara sin losetas y la fila de orificios. Paso y tamaño se leen de la foto y son aproximados;
- desaparece el aro oscuro que marcaba el final de las losetas a 4,58 m, porque ahí ya no terminan.

El número de losetas que dicen la ficha y la pantalla de carga se comprueba ahora contra el construido. El conjunto ya no lo declara dos veces: repetía el de la nave.
